...
import { useEdit, ekGet, EkIconBtn, EkAddBtn, T } from '../context/EditContext.jsx';
...
export const NOTE_ROTATIONS = [-2.5, 1.8, -1.2, 2.3, -2, 1.5, -1.8, 2];
...
// ─── TAG EDITOR ──────────────────────────────────────────────────────────────
export function TagEditor({ path, size = 10 }) {
...
// ─── STICKY NOTE ─────────────────────────────────────────────────────────────
export function StickyNote({ project, absIndex, rotation }) {
